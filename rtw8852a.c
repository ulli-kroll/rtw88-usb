...
#if 0
static void rtw8852ae_efuse_parsing(struct rtw_efuse *efuse,
				    struct rtw8822c_efuse *map)
{
	ether_addr_copy(efuse->addr, map->e.mac_addr);
}

static void rtw8852au_efuse_parsing(struct rtw_efuse *efuse,
				    struct rtw8822c_efuse *map)
{
...
static int rtw8852a_read_efuse(struct rtw_dev *rtwdev, u8 *log_map)
{
#if 1
	pr_info("%s ==>\n", __func__);
#else
...
static void rtw8852a_header_file_init(struct rtw_dev *rtwdev, bool pre)
{
...
static struct rtw_rqpn rqpn_table_8822c_loopback[] = {
	{RTW_DMA_MAPPING_NORMAL, RTW_DMA_MAPPING_NORMAL,
	 RTW_DMA_MAPPING_LOW, RTW_DMA_MAPPING_LOW,
	 RTW_DMA_MAPPING_EXTRA, RTW_DMA_MAPPING_HIGH},
	{RTW_DMA_MAPPING_NORMAL, RTW_DMA_MAPPING_NORMAL,
...
static struct rtw_chip_ops rtw8852a_ops = {
...
struct rtw_chip_info rtw8852a_hw_spec = {
	.ops = &rtw8852a_ops,
	...
	.rqpn_table_loopback = rqpn_table_8822c_loopback,
...
MODULE_FIRMWARE("rtw88/rtw8852a_fw.bin");

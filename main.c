...
unsigned int rtw_debug_mask = 0xFFFF;
...
static int rtw_dump_hw_feature(struct rtw_dev *rtwdev)
{
	...
	print_hex_dump(KERN_DEBUG, "hidden_mac:", DUMP_PREFIX_OFFSET, 16, 1,
		       hw_feature, sizeof(hw_feature), false);
